...
with tab_workspace[0]:
    ...
    with col_g1:
        ...
        # Restringimos las partículas al área visible para evitar fugas visuales en los bordes
        x_estatico = np.random.uniform(0.2, 9.8, total_particulas)
        y_estatico = np.random.uniform(-3, 3, total_particulas)
        
        # El factor 0.15 asegura que la perturbación mantenga la coherencia física visual
...
with tab_workspace[2]:
    ...
    with col_g3:
        ...
        if "Abierta-Abierta" in frontera_tipo:
            ...
            # Para Abierta-Abierta, la presión sigue una función coseno si medimos nodos correctamente, 
            # o seno dependiendo del origen. Usaremos funciones coherentes con las condiciones de frontera de presión.
